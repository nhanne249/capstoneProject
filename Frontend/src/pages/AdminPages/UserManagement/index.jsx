...
const UserManagement = () => {
    ...
    return (
        <div className="flex flex-col w-auto">
            <h1 className="text-3xl font-bold h-auto mb-10 mt-4 text-sky-800">Quản lý khách hàng</h1>
            <Table bordered columns={columns} dataSource={dataReceived} pagination={false} className="w-auto" />
            <Pagination defaultCurrent={1} defaultPageSize={10} className="self-end my-5" />
            <Modal
