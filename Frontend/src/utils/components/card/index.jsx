...
const Card = (value) => {
  ...
  return (
    <div
      ...
      className="relative group cursor-pointer overflow-hidden duration-500 w-64 h-[340px] bg-white text-teal-600 p-5 rounded-xl shadow-2xl"
    >
      ...
      <div className="absolute w-56 left-0 p-5 -bottom-8 duration-500 group-hover:-translate-y-8">
        <div className="absolute -z-10 left-0 w-64 h-28 opacity-0 duration-500 group-hover:opacity-50 group-hover:bg-teal-100"></div>
